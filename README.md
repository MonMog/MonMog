...
- Previous Projects:
  ...
  -   Developed several mods for a popular steam co-op game using Lua and UE4SS (an open-source software); all the mods together surpassed 4,000 unique downloads.
  -   Also developed another mod for another popular steam co-op game using dll decompiling for Unity, the sole mod has over 4,000 unique downloads.
